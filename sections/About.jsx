...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    <motion.p
      ...
      className=" mx-auto mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white"
    >
      ...
      of today, using only <span className="font-extrabold text-white">
        VR
      </span>{" "}
